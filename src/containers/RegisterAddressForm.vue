  ...
  <div class="container">
    <form class="address-form">
      <CustomInput
        ...
        :name="'CEP'"
        :customClasses="{
          'error': this.$v['addressModel'].cep.$dirty
            && this.$v['addressModel'].cep.$invalid
        }"
        :format="'#####-###'"
      />
      <CustomInput
        ...
        :name="'Endereço'"
        :customClasses="{
          'error': this.$v['addressModel'].address.$dirty
            && this.$v['addressModel'].address.$invalid
        }"
      />
      <CustomInput
        ...
        :name="'Número'"
        :customClasses="{
          'error': this.$v['addressModel'].number.$dirty
            && this.$v['addressModel'].number.$invalid
        }"
      />
      <CustomInput
      ...
      <CustomInput
        ...
        :name="'Cidade'"
        :customClasses="{
          'error': this.$v['addressModel'].city.$dirty
            && this.$v['addressModel'].city.$invalid
        }"
      />
      <CustomInput
        ...
        :name="'Estado'"
        :customClasses="{
          'error': this.$v['addressModel'].state.$dirty
            && this.$v['addressModel'].state.$invalid
        }"
        :inputType="'select'"
